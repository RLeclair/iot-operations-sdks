...
pub type GetRequest = rpc_command::invoker::Request<GetRequestSchema>;
pub type GetResponse = rpc_command::invoker::Response<GetResponsePayload>;
pub type GetResponseError = rpc_command::invoker::Response<SchemaRegistryError>;
...
pub struct GetRequestBuilder {
    inner_builder: rpc_command::invoker::RequestBuilder<GetRequestSchema>,
...
impl GetRequestBuilder {
    ...
    pub fn payload(&mut self, payload: GetRequestSchema) -> Result<&mut Self, AIOProtocolError> {
...
pub struct GetCommandInvoker<C>(rpc_command::Invoker<GetRequestSchema, GetResponseSchema, C>)
where
    ...
    C::PubReceiver: Send + Sync + 'static,
{
    ...
    pub async fn invoke(
        &self,
        request: GetRequest,
    ) -> Result<Result<GetResponse, GetResponseError>, AIOProtocolError> {
            ...
            Ok(response) => {
                if let Some(error) = response.payload.error {
                    ...
                    Err(AIOProtocolError {
                        ...
                        property_name: None,
                        property_value: None,
                        command_name: Some("get".to_string()),
