...
mod asset_event_group_status_schema_element_schema;
...
mod discovered_asset_event_group;
...
pub mod client {
    ...
    pub use super::asset_event_group_status_schema_element_schema::*;
    ...
    pub use super::discovered_asset_event_group::*;
