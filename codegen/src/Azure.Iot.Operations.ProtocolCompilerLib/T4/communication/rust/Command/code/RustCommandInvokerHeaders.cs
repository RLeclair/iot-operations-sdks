...
{
    public partial class RustCommandInvokerHeaders : ITemplateTransform
    {
        ...
        public string FileName { get => $"{this.commandName.GetFileName(TargetLanguage.Rust, "command", "invoker", "headers")}.rs"; }
