...
namespace Azure.Iot.Operations.Services.AssetAndDeviceRegistry.AdrBaseService
{
    ...
    {
        /// <summary>
        /// Specializes the <c>CommandInvoker</c> class for Command 'getAssetStatus'.
        /// </summary>
        public class GetAssetStatusCommandInvoker : CommandInvoker<GetAssetStatusRequestPayload, GetAssetStatusResponseSchema>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref="GetAssetStatusCommandInvoker"/> class.
            /// </summary>
